...
export default function Settings({ onClose }) {
        ...
        <div style={styles.section}>
          ...
          <div style={styles.toggle}>
            <div>
              ...
              <div style={styles.toggleDesc}>Другие не увидят когда ты онлайн</div>
            </div>
            <div
              style={{ ...styles.toggleBtn, background: hideOnline ? '#6c63ff' : '#2a2a2a' }}
        ...
        <div style={styles.section}>
          ...
          <div style={styles.toggle}>
            <div>
              ...
              <div style={styles.toggleDesc}>Получать уведомления о новых сообщениях</div>
            </div>
            <div
              style={{ ...styles.toggleBtn, background: notifications ? '#6c63ff' : '#2a2a2a' }}
  ...
  <button style={styles.btnDelete} onClick={() => {
    if (window.confirm('Ты уверен? Аккаунт будет удалён навсегда!')) {
      fetch('https://gi-chat-production.up.railway.app/api/auth/delete', {
        method: 'DELETE',
