...
export default function ChatWindow({ onSendMessage, onTyping, onStopTyping, socket }) {
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        <div
          style={{ ...styles.headerInfo, cursor: currentChat ? 'pointer' : 'default' }}
        ...
        >
          <div style={{
            ...
            height: '44px',
            borderRadius: '50%',
            background: currentGroup ? getColor(currentGroup.name) : getColor(currentChat || 'U'),
            display: 'flex',
            alignItems: 'center',
        ...
        {currentChat && !currentGroup && (
          <div style={{ display: 'flex', gap: '10px', marginRight: '16px' }}>
            <button style={styles.btnCall} onClick={() => setCallModal({ type: 'audio' })}>📞</button>
            <button style={styles.btnCall} onClick={() => setCallModal({ type: 'video' })}>📹</button>
          </div>
        )}
      </div>
